...
Version  : 21.08.3
Release  : 34
URL      : https://download.kde.org/stable/release-service/21.08.3/src/kturtle-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/kturtle-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/kturtle-21.08.3.tar.xz.sig
...
%prep
%setup -q -n kturtle-21.08.3
cd %{_builddir}/kturtle-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636051255
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kturtle-21.08.3/COPYING.DOC %{buildroot}/usr/share/package-licenses/kturtle/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kturtle-21.08.3/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kturtle/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kturtle-21.08.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kturtle/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kturtle
