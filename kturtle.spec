...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/kturtle-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/kturtle-23.08.2.tar.xz.sig
...
%prep
%setup -q -n kturtle-23.08.2
cd %{_builddir}/kturtle-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697236474
mkdir -p clr-build
pushd clr-build
