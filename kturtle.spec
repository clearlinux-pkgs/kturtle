...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/kturtle-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/kturtle-21.12.2.tar.xz.sig
...
%prep
%setup -q -n kturtle-21.12.2
cd %{_builddir}/kturtle-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644000171
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kturtle-21.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/kturtle/1bd373e4851a93027ba70064bd7dbdc6827147e1
cp %{_builddir}/kturtle-21.12.2/LICENSES/GPL-2.0-only.txt %{buildroot}/usr/share/package-licenses/kturtle/2a638514c87c4923c0570c55822620fad56f2a33
cp %{_builddir}/kturtle-21.12.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/kturtle/e712eadfab0d2357c0f50f599ef35ee0d87534cb
pushd clr-build
%make_install
popd
%find_lang kturtle
