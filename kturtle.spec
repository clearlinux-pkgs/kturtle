...
Version  : 19.12.1
Release  : 17
URL      : https://download.kde.org/stable/release-service/19.12.1/src/kturtle-19.12.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.1/src/kturtle-19.12.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.1/src/kturtle-19.12.1.tar.xz.sig
...
%prep
%setup -q -n kturtle-19.12.1
cd %{_builddir}/kturtle-19.12.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578682521
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kturtle-19.12.1/COPYING %{buildroot}/usr/share/package-licenses/kturtle/195cd90a7a5f5e9501801a162c6329f155ecf01a
cp %{_builddir}/kturtle-19.12.1/COPYING.DOC %{buildroot}/usr/share/package-licenses/kturtle/1bd373e4851a93027ba70064bd7dbdc6827147e1
pushd clr-build
%make_install
popd
%find_lang kturtle
